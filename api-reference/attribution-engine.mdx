...
| | `datasource_created` |
| | `widget_installed` |
| **Revenue** | `customer.created.complete` |
| | `invoice.paid` |
...
<Tabs>
  <Tab title="Google Ads">
    ...
    **Event mapping:**
    ...
    | <code style={{whiteSpace: 'nowrap'}}>customer.created.complete</code><br/><code style={{whiteSpace: 'nowrap'}}>invoice.paid</code> | Custom event | Google Ads API<br/>+ Google gtag | Enrichment (Smart Bidding signal) |
  ...
  <Tab title="Meta (Facebook/Instagram)">
    ...
    **Event mapping:**
    ...
    | <code style={{whiteSpace: 'nowrap'}}>customer.created.complete</code><br/><code style={{whiteSpace: 'nowrap'}}>invoice.paid</code> | `Purchase`<br/>`Subscribe` | Meta Conversions API (CAPI)<br/>+ Facebook Pixel | Enrichment (not conversion goal) |
