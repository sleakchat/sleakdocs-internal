...
Visit this URL in your work browser: https://data.sleak.chat/mark-internal-browser - **from both your office and home connections**, since each has a different public IP. This sets a browser marker and also records your public IP server-side, so you stay excluded even after clearing cookies. Re-visit if your IP changes.
